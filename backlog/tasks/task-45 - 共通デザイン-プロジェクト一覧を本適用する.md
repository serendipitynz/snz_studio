...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 プロジェクトのカードに焦点が来たとき、焦点の枠が見える (doc-16 §6.3)
- [ ] #2 ドラッグの並べ替えに、キーボードの代替と単一ポインタの代替がある (doc-9 §6.9・doc-5 §4.1 の 2.5.7)
- [ ] #3 失敗の語が、失敗した操作の対象の近くに失敗の段の図形とともに出る (doc-9 §5.5・§6.4)
- [ ] #4 主操作のボタンが画面に1つまでである (doc-8 §6.1)
